...
<p>The main purpose of this project is to learn the principles of NextJS, which is a Front-End Framework, such as SSR (Server Side Rendering), SSG (Static Site Generating), web performance, routing by file system, and how this tool helps us developers to make pages trackable for browsers bots aiming to improve the SEO.</p>
