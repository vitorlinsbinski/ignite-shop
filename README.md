...
<p>The main purpose of this project is to learn the principles of NextJS Front-End Framework, such as SSR (Server Side Rendering), SSG (Static Site Generator), web performance, routing by directories, and how this tool helps us developers to make pages trackable for browsers bots aiming to improve the SEO.</p>
